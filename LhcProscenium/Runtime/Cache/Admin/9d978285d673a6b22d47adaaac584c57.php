    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
            <div class="col-sm-3">
                <div class="ibox">
                    <div class="ibox-content">
                        <h2 class="m-b-md">今日访问:</h2>
                        <h2 class="text-navy">
							<i class="fa fa-play fa-rotate-270"></i> 6321
						</h2>
                        <!-- <small>更新时间：12天以</small> -->
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-3">
                <div class="ibox">
                    <div class="ibox-content ">
                        <h2 class="m-b-md">今日注册:</h2>
                        <h2 class="text-navy">
                                    <i class="fa fa-play fa-rotate-270"></i> 1263
                                </h2>
            ...
            <div class="col-sm-3">
                <div class="ibox">
                    <div class="ibox-content">
                        <h2 class="m-b-md">会员办理</h2>
                        <h2 class="text-danger">
                                    <i class="fa fa-play fa-rotate-90"></i> 632
                                </h2>
                        <!-- <small>更新时间：12天以前</small> -->
                    </div>
                </div>
            ...
            <div class="col-sm-3">
                <div class="ibox">
                    <div class="ibox-content">
                        <h2 class="m-b-md">今日动态</h2>
                        <h2 class="text-danger">
                                    <i class="fa fa-play fa-rotate-90"></i> 76234
                                </h2>
                        <!-- <small>更新时间：12天以前</small> -->
                    </div>
                </div>
