                ...
                <div class="row">
							...
							<div class="ibox float-e-margins">	
								<div class="ibox-title">
									...
									<?php if($k['did']): ?>&nbsp;&nbsp;<i class='glyphicon glyphicon-fire' style='font-size:20px;color:red;'></i><?php endif; ?>
									<div class="ibox-tools">
										<a style='color:blue;' class="collapse-link">
											<<<
										</a>
										<!-- <a style='color:blue;' href='/index.php/Admin/Dynamic/index/where/NormalUser'>
									...
									<div class="social-feed-box">
										...
										<div class="pull-right social-action dropdown">
											...
											<ul class="dropdown-menu m-t-xs">
												<li><a href="/index.php/Admin/Dynamic/del_dynamic/id/<?php echo ($k['id']); ?>">删除当前区域动态</a></li>
											</ul>
										</div>
											...
											<table border='0px' height='100%' cellspacing='0px' >
												<?php if(is_array($comment[$cnum])): foreach($comment[$cnum] as $key=>$ck): ?><tbody>
													...
													<tr>
														...
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/index.php/Admin/Dynamic/del_dynamicComment/id/<?php echo ($ck['id']); ?>">删除</a>&nbsp;&nbsp;&nbsp;</td>
													</tr>
