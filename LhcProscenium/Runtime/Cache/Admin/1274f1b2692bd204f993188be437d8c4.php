            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
						<?php if($status == 1): ?><span style='font-size:14px;' class='label label-primary'>实名认证通过表</span>
						<?php else: ?>
							<span style='font-size:14px;' class='label label-primary'>实名认证审核表</span><?php endif; ?>
