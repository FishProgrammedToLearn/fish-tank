                ...
                <div class="row">
							...
							<div class="ibox float-e-margins">	
								<div class="ibox-title">
									...
									<span class='label label-warning-light' style='font-size:13px;'>(<?php echo (date("Y-m-d H:i:s",$k['time'])); ?>)</span><small></small>
									<div class="ibox-tools">
										<a style='color:blue;' class="collapse-link">
											<<<
										</a>
										<a style='color:blue;' href='/index.php/Admin/User/index/where/NormalUser'>
									...
									<div class="social-feed-box">
										...
										<div class="pull-right social-action dropdown">
											...
											<ul class="dropdown-menu m-t-xs">
												<li><a href="/index.php/Admin/User/del_dynamic/id/<?php echo ($k['id']); ?>">删除当前区域动态</a></li>
											</ul>
										</div>
										...
										<div class="social-body">
											...
											<div>
												<!-- <img width='400px' src='/Public/img/1.jpg' />
												<img width='400px' src='/Public/img/2.jpg' />
												<img width='400px' src='/Public/img/3.jpg' />
												<img width='400px' src='/Public/img/1.jpg' /> -->
											</div>
											<br/>
											<div class="">
											...
											<table border='0px' height='100%' cellspacing='0px' >
												<?php if(is_array($comment[$cnum])): foreach($comment[$cnum] as $key=>$ck): ?><tbody>
													...
													<tr>
														...
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/index.php/Admin/User/del_dynamicComment/id/<?php echo ($ck['id']); ?>">删除</a>&nbsp;&nbsp;&nbsp;</td>
													</tr>
								...
								<div class="middle-box text-center animated fadeInDown">
									<h1 style='font-size:40px;'>当前用户并无动态</h1>
									<br/>
