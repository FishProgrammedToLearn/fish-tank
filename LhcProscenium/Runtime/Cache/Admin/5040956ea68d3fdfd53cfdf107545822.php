							...
							<div class="ibox float-e-margins">	
								<div class="ibox-title">
									...
									<div class="ibox-tools">
										...
										<!-- <a style='color:blue;' href='/index.php/Admin/HotDynamic/index/where/NormalUser'>
											<i class="glyphicon glyphicon-repeat"></i> 返回
										</a> -->
										<?php if($k['hot'] == 1): ?><a style='color:red;' href="/index.php/Admin/HotDynamic/remove/did/<?php echo ($k['id']); ?>" class="collapse-link">
												<b>移出热门</b>
											</a>
										<?php else: ?>
											<a style='color:red;' href="/index.php/Admin/HotDynamic/insert/did/<?php echo ($k['id']); ?>" class="collapse-link">
												<b>添加热门</b>
											</a><?php endif; ?>
									</div>
								</div>
									...
									<div class="social-feed-box">
										...
										<div class="pull-right social-action dropdown">
											...
											<ul class="dropdown-menu m-t-xs">
												<li><a href="/index.php/Admin/HotDynamic/del_dynamic/id/<?php echo ($k['id']); ?>">删除当前区域动态</a></li>
											</ul>
										</div>
												...
												<?php if(is_array($comment[$cnum])): foreach($comment[$cnum] as $key=>$ck): ?><tbody>
													<tr>
														<td rowspan='2' width='40px'>
															<img width='40px' src="/Public/UserHead/<?php echo ($ck['picture']); ?>" /></td>
													...
													<tr>
														...
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/index.php/Admin/HotDynamic/del_dynamicComment/id/<?php echo ($ck['id']); ?>">删除</a>&nbsp;&nbsp;&nbsp;</td>
													</tr>
								...
								<div class="middle-box text-center animated fadeInDown">
									<h1 style='font-size:40px;'>当前分类并无动态</h1>
									<br/>
