            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
						<?php if($info['status'] == 0): ?><span style='font-size:14px;' class='label label-primary'>实名认证申请表</span>
						<?php else: ?>
							<span style='font-size:14px;' class='label label-primary'>实名认证通过表</span><?php endif; ?>
                    ...
                    <div class="ibox-content">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            <tbody>   
								...
								<tr class="gradeX">
									<td>身份证正面</td>
									<td><img src="/Public/authentication/<?php echo ($info['front_picture']); ?>" style="width:500px;"/></a></td>
								</tr>
								<tr class="gradeX">
									<td>身份证反面</td>
									<td><img src="/Public/authentication/<?php echo ($info['reverse_picture']); ?>" style="width:500px;"/></td>
								</tr>
								<tr class="gradeX">
									<td>身份证号</td>
								...
								<?php if($info['status'] == 0): ?><tr><td colspan='2'>
										<div class="col-sm-6" >
											<button onclick="javascript:location.href='/index.php/Admin/Attestation/Ayes/nickname/<?php echo ($info['nickname']); ?>';" class="btn btn-primary btn-sm btn-block"><i class="fa fa-coffee"></i> 通过</button>
										</div>
										<div class="col-sm-6">
											<button onclick="javascript:location.href='/index.php/Admin/Attestation/Ano/nickname/<?php echo ($info['nickname']); ?>';" class="btn btn-danger btn-sm btn-block"><i class="fa fa-coffee"></i> 否决</button>
										</div>
									</td></tr><?php endif; ?>
                            </tbody>
                        </table>
