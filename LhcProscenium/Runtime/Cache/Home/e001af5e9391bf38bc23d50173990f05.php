	...
	<script>
		$(function(){
			...
			$(document).on('click',".etrue",function(){
				...
				$.ajax({
				    type: "POST",
				    url: "/index.php/Home/LeftVideo/AjaxECancel",
				    data: "id="+did,
					async:false,
			...
			$(document).on('click',".efalse",function(){
				...
				$.ajax({
				    type: "POST",
				    url: "/index.php/Home/LeftVideo/AjaxEAdd",
				    data: "id="+did,
					async:false,
					success:function(data){
						m = data;
...
//=================评论点赞
			...
			$(document).on('click',".CEtrue",function(){
				...
				$.ajax({
				    type: "POST",
				    url: "/index.php/Home/LeftVideo/AjaxCECancel",
				    data: "id="+cid,
					async:false,
					success:function(data){
						m = data;
			...
			$(document).on('click',".CEfalse",function(){
				...
				$.ajax({
				    type: "POST",
				    url: "/index.php/Home/LeftVideo/AjaxCEAdd",
				    data: "id="+cid,
					async:false,
					success:function(data){
						m = data;
...
//======================================
			...
			$(document).on('click',".ctrue",function(){
				...
				$.ajax({
				    type: "POST",
				    url: "/index.php/Home/LeftVideo/AjaxCCancel",
				    data: "id="+did,
					async:false,
					success:function(data){
						m = data;
			...
			$(document).on('click',".cfalse",function(){
				...
				$.ajax({
				    type: "POST",
				    url: "/index.php/Home/LeftVideo/AjaxCAdd",
				    data: "id="+did,
					async:false,
					success:function(data){
						m = data;
			...
			$(".idc").click(function(){
				...
				$.ajax({
					type: "POST",
					url: "/index.php/Home/LeftVideo/InsertDC",
			...
			$(document).on('click',".del_dynamicComment",function(){
				...
				swal({
					...
					$.ajax({
						type: "POST",
						url: "/index.php/Home/LeftVideo/delDynamicComment",
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
									...
									<div class="social-feed-box">
										<?php if(($k['nickname']) == $_SESSION['nickname']): ?><div class="pull-right social-action dropdown">
											...
											<ul class="dropdown-menu m-t-xs">
												<?php if(($k['display']) == "0"): ?><li><a href="/index.php/Home/LeftVideo/block_dynamic/id/<?php echo ($k['id']); ?>">显示动态</a></li><?php endif; ?>
												<?php if(($k['display']) == "1"): ?><li><a href="/index.php/Home/LeftVideo/none_dynamic/id/<?php echo ($k['id']); ?>">隐藏动态</a></li><?php endif; ?>
												<li><a href="/index.php/Home/LeftVideo/del_dynamic/id/<?php echo ($k['id']); ?>">删除动态</a></li>
											</ul>
										</div><?php endif; ?>
		...
		<div style='display:none;'><?php echo ($num++); echo ($num++); echo ($cnum++); ?></div><?php endforeach; endif; ?>
			...
			<div class="middle-box text-center animated fadeInDown">
				<h1 style='font-size:40px;'>当前没有视频动态~~~</h1>
				<br/>
