	...
	<script>
		$(function(){
			...
			$(document).on('click',"#attention",function(){
				...
				$.ajax({
				    type: "POST",
				    url: "/index.php/Home/MyCenter/Attention",
			...
			$(document).on('click',"#cancelAttention",function(){
				...
				$.ajax({
				    type: "POST",
				    url: "/index.php/Home/MyCenter/cancelAttention",
				    data: "nickname="+nickname,
					async:false,
					success:function(data){
						m = data;
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
						...
						<div class="ibox-tools">
							...
							<?php if(($info["nickname"]) == $_SESSION['nickname']): ?><a style='color:blue;' href='/index.php/Home/MyCenter/renewal'>
