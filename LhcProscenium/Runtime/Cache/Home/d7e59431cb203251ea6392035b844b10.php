	...
	<script>
		$(function(){
			$("input").blur(function(){
				$.ajax({
				    type: "POST",
				    url: "/index.php/Home/LeftEnterprise/AjaxInsert",
...
<body class="gray-bg">
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
		<div class="row">
		<?php if(empty($astatus and estatus)): ?><div class="col-sm-12">
                <div class="ibox float-e-margins">
					<div class="ibox-title">
                        <span class='label label-primary' style='font-size:16px;'>IH企业认证</span>
					    <div class="ibox-tools">
							<!-- <a style='color:blue;' href='/index.php/Home/LeftEnterprise/information'>
                    ...
                    <div class="ibox-content">
                        <form method="post" action="/index.php/Home/LeftEnterprise/insert" enctype="multipart/form-data" class="form-horizontal">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">上传营业执照</label>
                                <div class="col-sm-10">
									<div id="preview" style='float:left;' >
										<img id="imghead" alt="image" src="/Public/enterprise/enterprise.jpg" width='300px' onClick="$('#previewImg').click();"/>
									</div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" style='width:600px;float:left;' name="name_number">
									<span class="help-block m-b-none" style='float:left;font-size:16px;color:red;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
									<span class="help-block m-b-none" style='float:left;font-size:16px;color:red;'></span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" style='width:600px;float:left;' name="telephone">
									<span class="help-block m-b-none" style='float:left;font-size:16px;color:red;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
