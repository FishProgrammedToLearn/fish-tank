        ...
        <div class="row">
			<?php if($info): if(is_array($info)): foreach($info as $key=>$k): ?><div class="col-sm-4">
						<div class="contact-box">
								...
								<?php else: ?>
									<?php if($_SESSION['nickname']== $k['nickname']): ?>&nbsp;&nbsp;<button name="attention" disabled ckname="<?php echo ($k['nickname']); ?>" class='btn btn-danger btn-sm' style='color:white;'>&nbsp;&nbsp;&nbsp;关&nbsp;注&nbsp;&nbsp;&nbsp;</button>&nbsp;&nbsp;
									<?php else: ?>
										&nbsp;&nbsp;<button name="attention" nickname="<?php echo ($k['nickname']); ?>" class='btn btn-danger btn-sm' style='color:white;'>&nbsp;&nbsp;&nbsp;关&nbsp;注&nbsp;&nbsp;&nbsp;</button>&nbsp;&nbsp;<?php endif; endif; ?>
								<a href="/index.php/Home/HomePage/viewDetails/nickname/<?php echo ($k['nickname']); ?>" class='btn btn-primary btn-sm' style='color:white'>查看信息</a>&nbsp;&nbsp;
								<a href="/index.php/Home/HomePage/viewDynamic/nickname/<?php echo ($k['nickname']); ?>" class='btn btn-warning btn-sm' style='color:white'>查看动态</a>
