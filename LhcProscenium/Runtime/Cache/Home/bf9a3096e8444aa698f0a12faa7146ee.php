	...
	<script>
		$(function(){
			...
			$(document).on('click',".etrue",function(){
				...
				$.ajax({
				    type: "POST",
				    url: "/index.php/Home/LeftMyDynamic/AjaxECancel",
				    data: "id="+did,
					async:false,
			...
			$(document).on('click',".efalse",function(){
				...
				$.ajax({
				    type: "POST",
				    url: "/index.php/Home/LeftMyDynamic/AjaxEAdd",
				    data: "id="+did,
					async:false,
					success:function(data){
						m = data;
...
//=================评论点赞
			...
			$(document).on('click',".CEtrue",function(){
				...
				$.ajax({
				    type: "POST",
				    url: "/index.php/Home/LeftMyDynamic/AjaxCECancel",
				    data: "id="+cid,
					async:false,
					success:function(data){
						m = data;
			...
			$(document).on('click',".CEfalse",function(){
				...
				$.ajax({
				    type: "POST",
				    url: "/index.php/Home/LeftMyDynamic/AjaxCEAdd",
				    data: "id="+cid,
					async:false,
					success:function(data){
						m = data;
...
//======================================
			...
			$(document).on('click',".ctrue",function(){
				...
				$.ajax({
				    type: "POST",
				    url: "/index.php/Home/LeftMyDynamic/AjaxCCancel",
				    data: "id="+did,
					async:false,
					success:function(data){
						m = data;
			...
			$(document).on('click',".cfalse",function(){
				...
				$.ajax({
				    type: "POST",
				    url: "/index.php/Home/LeftMyDynamic/AjaxCAdd",
				    data: "id="+did,
					async:false,
					success:function(data){
						m = data;
			...
			$(".idc").click(function(){
				...
				$.ajax({
					type: "POST",
					url: "/index.php/Home/LeftMyDynamic/InsertDC",
			...
			$(document).on('click',".del_dynamicComment",function(){
				...
				swal({
					...
					$.ajax({
						type: "POST",
						url: "/index.php/Home/LeftMyDynamic/delDynamicComment",
									...
									<div class="social-feed-box">
										<?php if(($k['nickname']) == $_SESSION['nickname']): ?><div class="pull-right social-action dropdown">
											...
											<ul class="dropdown-menu m-t-xs">
												<?php if(($k['display']) == "0"): ?><li><a href="/index.php/Home/LeftMyDynamic/block_dynamic/id/<?php echo ($k['id']); ?>">显示动态</a></li><?php endif; ?>
												<?php if(($k['display']) == "1"): ?><li><a href="/index.php/Home/LeftMyDynamic/none_dynamic/id/<?php echo ($k['id']); ?>">隐藏动态</a></li><?php endif; ?>
												<li><a href="/index.php/Home/LeftMyDynamic/del_dynamic/id/<?php echo ($k['id']); ?>">删除动态</a></li>
											</ul>
										</div><?php endif; ?>
