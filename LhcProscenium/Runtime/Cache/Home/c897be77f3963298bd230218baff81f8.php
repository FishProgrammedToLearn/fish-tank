							...
							<div class="ibox float-e-margins">	
								<div class="ibox-title">
									...
									<div class="ibox-tools">
										...
										<!-- <a style='color:blue;' href='/index.php/Home/Detail/index/where/NormalUser'>
									...
									<div class="social-feed-box">
										...
										<div class="pull-right social-action dropdown">
											...
											<ul class="dropdown-menu m-t-xs">
												<li><a href="/index.php/Home/Detail/del_dynamic/id/<?php echo ($k['id']); ?>">删除当前区域动态</a></li>
											</ul>
										</div>
											...
											<table border='0px' height='100%' cellspacing='0px' >
												<?php if(is_array($comment[$cnum])): foreach($comment[$cnum] as $key=>$ck): ?><tbody>
													...
													<tr>
														...
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/index.php/Home/Detail/del_dynamicComment/id/<?php echo ($ck['id']); ?>">删除</a>&nbsp;&nbsp;&nbsp;</td>
													</tr>
