                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
						...
						<div class="ibox-tools">
							...
							<?php if(($info["nickname"]) == $_SESSION['nickname']): ?><a style='color:blue;' href='/index.php/Home/LeftMyAttention/renewal'>
                    ...
                    <div>
                        ...
                        <div class="ibox-content profile-content">
							<span><img alt="image" class="img-circle"  src="/Public/UserHead/<?php echo ($info['picture']); ?>" width="65px"/></span>
							<br/>
