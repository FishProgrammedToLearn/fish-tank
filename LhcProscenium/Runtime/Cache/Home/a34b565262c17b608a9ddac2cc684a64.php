				...
				<!--模块1-->
					...
					<div class="ibox float-e-margins">
						<div class="ibox-title">
							<span class="label label-primary" style='font-size:14px;'>与我相关~</span>
							<!-- <div class="ibox-tools">
							<a><span class="label label-warning-light">更多<i class='glyphicon glyphicon-menu-right'></i></span></a>
							</div> -->
						</div>
						<div class="ibox-content no-padding">
						<div height='90%'>
						<ul class="list-group" style='text-align:center;'>
							<?php if(is_array($info)): foreach($info as $key=>$k): ?><li class="list-group-item">
								<?php switch($k["condition"]): case "@": ?><a href='' target='iframe0'>
											<span style='color:red;'><strong><?php echo ($k['nickname']); ?>@了你</strong></span>
											<span style='float:right;color:#F8AC59'>
												<strong><?php echo (date("Y-m-d H:i:s",$k['time'])); ?></strong>
											</span>
										</a><?php break;?>
									<?php case "收藏": ?><a href='' target='iframe0'>
											<span style='color:red;'><strong><?php echo ($k['nickname']); ?>收藏了你的动态</strong></span>
											<span style='float:right;color:#F8AC59'>
												<strong><?php echo (date("Y-m-d H:i:s",$k['time'])); ?></strong>
											</span>
										</a><?php break;?>
									<?php case "赞": ?><a href='' target='iframe0'>
											<span style='color:red;'><strong><?php echo ($k['nickname']); ?>赞了你的动态</strong></span>
											<span style='float:right;color:#F8AC59'>
												<strong><?php echo (date("Y-m-d H:i:s",$k['time'])); ?></strong>
											</span>
										</a><?php break;?>
									<?php case "关注": ?><a href='' target='iframe0'>
											<span style='color:red;'><strong><?php echo ($k['nickname']); ?>关注了你</strong></span>
											<span style='float:right;color:#F8AC59'>
												<strong><?php echo (date("Y-m-d H:i:s",$k['time'])); ?></strong>
											</span>
										</a><?php break;?>
									<?php default: ?>
										<span style='color:red;'><strong><?php echo ($k['nickname']); echo ($k['condition']); ?></strong></span>
										<span style='float:right;color:#F8AC59'>
											<strong><?php echo (date("Y-m-d H:i:s",$k['time'])); ?></strong>
										</span>
									</case><?php endswitch;?>
								...
								<li class="list-group-item"><?php endforeach; endif; ?>
						</ul>
						</div>
						</div>
					</div>
