							...
							<div class="ibox float-e-margins">	
								<div class="ibox-title">
									...
									<div class="ibox-tools">
										...
										<!-- <a style='color:blue;' href='/index.php/Home/Dynamic/index/where/NormalUser'>
									...
									<div class="social-feed-box">
										<?php if(($k['nickname']) == $_SESSION['nickname']): ?><div class="pull-right social-action dropdown">
												...
												<ul class="dropdown-menu m-t-xs">
													<li><a href="/index.php/Home/Dynamic/none_dynamic/id/<?php echo ($k['id']); ?>">隐藏动态</a></li>
											...
											<table border='0px' height='100%' cellspacing='0px' >
												<?php if(is_array($comment[$cnum])): foreach($comment[$cnum] as $key=>$ck): ?><tbody>
													...
													<tr>
														...
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/index.php/Home/Dynamic/del_dynamicComment/id/<?php echo ($ck['id']); ?>">删除</a>&nbsp;&nbsp;&nbsp;</td>
													</tr>
