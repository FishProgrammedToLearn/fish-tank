(function($) {
    ...
    var t = null;
    var u = ["moveInRight", "bounceInZ"];
    
    (function() {
        'use strict';
        var s = function(e, f) {
            var n = this;
            var g = { container: e, width: 300, height: 200, sources: [], type: "flip" };
            var h = null;
            var i = null;
            var j = 0;
            f = f || {};
            ...
            for (var l in f) {
                if (typeof f[l] === 'object') {
                    k[l] = {};
                    for (var m in f[l]) { k[l][m] = f[l][m] }
                } else { k[l] = f[l] }
            };
            for (var o in g) {
                if (typeof f[o] === 'object') {
                    for (var p in g[o]) {
                        if (typeof f[o][p] === 'undefined') { f[o][p] = g[o][p] }
                    }
                } else if (typeof f[o] === 'undefined') { f[o] = g[o] }
            };
            n.params = f;
            n.originParams = k;
            var q = function(a, b, c, d) {
                if (a.addEventListener) { a.addEventListener(b, c, d) } else if (a.attachEvent) { a.attach("on" + b, c) }
            };
            var r = function() {
                        ...
                        (function(b, c, d) {
                            ...
                            setTimeout(function() {
                                n.animate(b, function(a) {
                                    ...
                                    if (a.x > 90) { b.style.transform = "perspective(500px) rotateY(" + a.x + "deg) scale(-1, 1)" } else { b.style.transform = "perspective(500px) rotateY(" + a.x + "deg)" }
                                }, function() {
                                    if ((--f) == 0) {
